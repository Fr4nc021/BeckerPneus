...
import economicoImage from './assets/tipo/economico.png'
      ...
      <div className="header-container">
        ...
        <div className="logo">
          ...
          <div className="logo-text">
            <span className="logo-becker">Becker</span>
            <span className="logo-pneus">Pneus</span>
          </div>
        </div>
        ...
        <nav className={`nav ${isMenuOpen ? 'nav-open' : ''}`}>
          ...
          <a href="#" className="nav-link" onClick={() => setIsMenuOpen(false)}>Serviços</a>
          <a href="#" className="nav-link" onClick={() => setIsMenuOpen(false)}>Marcas</a>
          <a href="#" className="nav-link" onClick={() => setIsMenuOpen(false)}>Contato</a>
        </nav>
    ...
    <section id="tipos" className="vehicle-types fade-in" ref={(el) => { sectionsRef.current[3] = el }}>
      <div className="vehicle-types-container">
        ...
        <div className="vehicle-types-cards">
          ...
          <div className="vehicle-card">
            <div className="vehicle-card-image-wrapper">
              <img src={economicoImage} alt="Pneus Econômicos" className="vehicle-card-image" />
            </div>
            <h3 className="vehicle-card-title">Pneus Econômicos</h3>
            <p className="vehicle-card-description">
      ...
      <div className="contact-section-dark-container">
        ...
        <div className="contact-section-dark-cards">
          ...
          <div className="contact-info-card-dark">
            ...
            <h3 className="contact-info-title-dark">Endereço</h3>
            <p className="contact-info-text-dark">Rua Exemplo, 123<br />Centro - Cidade/Estado<br />CEP 12345-678</p>
          </div>
          ...
          <div className="contact-info-card-dark">
            ...
            <h3 className="contact-info-title-dark">Horário de Funcionamento</h3>
            <p className="contact-info-text-dark">Segunda a Sexta: 8h às 18h<br />Sábado: 8h às 12h<br />Domingo: Fechado</p>
          </div>
        </div>
      </div>
    </section>
          ...
          <div className="footer-logo-section">
            <div className="footer-logo">
              <div className="footer-logo-circle">
                <span className="footer-logo-letter">B</span>
              </div>
              <div className="footer-logo-text">
                <span className="footer-logo-becker">Becker</span>
                <span className="footer-logo-pneus">Pneus</span>
              </div>
            </div>
          ...
          <div className="footer-contact">
            ...
            <ul className="footer-contact-list">
              <li>
                ...
                <span>Rua Exemplo, 123<br />Centro - Cidade/Estado</span>
              </li>
              <li>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
